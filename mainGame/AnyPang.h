...
void AnyPang()
{
    ...
    {
        system("cls");
        PlaySound(TEXT("C:\\Users\\KimHaYeon\\source\\repos\\mainGame\\AnyPangBgm.wav"), NULL, SND_FILENAME | SND_ASYNC | SND_LOOP | SND_NODEFAULT);
...
{
    FILE* fp;
    fp = fopen("C:\\Users\\KimHaYeon\\source\\repos\\mainGame\\AnyBestScore.txt", "rt");        // "rt" 읽기 모드
...
void AnyWriteData()
{
    ...
    fp = fopen("C:\\Users\\KimHaYeon\\source\\repos\\mainGame\\AnyBestScore.txt", "wt");        // "wt" 쓰기모드
