...
void Maze()
{
    ...
    {
        system("cls");
        PlaySound(TEXT("C:\\Users\\KimHaYeon\\source\\repos\\mainGame\\MazeBgm.wav"), NULL, SND_FILENAME | SND_ASYNC | SND_LOOP | SND_NODEFAULT);
...
{
    FILE* fp;
    fp = fopen("C:\\Users\\KimHaYeon\\source\\repos\\mainGame\\MazeBestScore.txt", "rt");               // 읽기 모드
...
void WriteData()
{
    ...
    fp = fopen("C:\\Users\\KimHaYeon\\source\\repos\\mainGame\\MazeBestScore.txt", "wt");               // 쓰기모드로 파일 열기
